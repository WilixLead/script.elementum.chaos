...
def get_icon_path():
    """ Utility method to Chaos's icon path

    Returns:
        str: Path to Chaos's icon
    """
...
def clear_cache():
    """ Clears cookies from Chaos's cache
    """
    cookies_path = os.path.join(xbmc.translatePath("special://temp"), "chaos")
